  ...
  try {
    ...
    res.end = function(chunk, encoding) {
      try {
        ...
        console.warn('Error logging response:', error.message);
      }
    ...
    console.warn('Error in request logger:', error.message);
    next();
  }
};
...
const errorLogger = (err, req, res, next) => {
  try {
    ...
    console.warn('Error in error logger:', logError.message);
  }
  ...
  try {
    ...
    res.end = function(chunk, encoding) {
      try {
        ...
        console.warn('Error logging response in console logger:', error.message);
      }
    ...
    console.warn('Error in console request logger:', error.message);
    next();
  }
};
